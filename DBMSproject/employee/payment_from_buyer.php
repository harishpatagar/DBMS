...
require_once ("payment_from_buyer_operation.php");
session_start();
...
<head>
    ...
    <title>payment from buyer</title>
...
<main>
    <div class="container text-center">
        <h1 class="py-4 bg-info text-light rounded"><i class="fas fa-swatchbook"></i>payment_from_buyer</h1>
         
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                    <div class="row pt-2">
                     <div class="col">
                         <?php inputElement("number","buyer_id", "buyer_id","",""); ?> <!-- replace after with fun!-->
                     </div>
                    <div class="col">
...
if(isset($_POST['read'])){
    ...
    if($result){
        ...
        while ($row = mysqli_fetch_assoc($result)){ ?>
            ...
            <tr>
                <td  data-id="<?php echo $row['recipt_no'];?>"><?php echo $row['buyer_id']; ?></td>
...
<script src="payment_from_buyer.js"></script>
</body>
</html>
