...
require_once ("buyer_transaction_operation.php");
session_start();
...
<main>
    <div class="container text-center">
        <h1 class="py-4 bg-info text-light rounded"><i class="fas fa-swatchbook"></i>Buyers transaction</h1>
         
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                    <div class="row pt-2">
                    <div class="col">
                    <?php inputElement("text","buyer_id", "buyer_id","",""); ?> 
                   </div>
                   <div class="col">
                    <?php inputElement("text","transaction_id", "transaction_id","","readonly"); ?> 
                   </div>
                   <div class="col">
                        <?php inputElement("date","sell_date", "sell_date","",""); ?>
                   </div>
                    </div>
                   <div class="row pt-2">
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <?php inputElement("text","buyprice_A", "sellprice_A","",""); ?>
                    </div>
                    <div class="col">
                        <?php inputElement("text","buyprice_B", "sellprice_B","",""); ?>
                    </div>
                    <div class="col">
                        <?php inputElement("text","buyprice_C", "sellprice_C","",""); ?>
                    </div>
                   </div>
                   </br>
                <div class="pt-2">
            ...
            <table class="table table-striped table-warning">
                <thead class=" bg-success">
                    <tr>
                        ...
                        <th>Sell_price_A (rupies)</th>
                        <th>Sell_price_B (rupies)</th>
                        <th>Sell_price_C (rupies)</th>
    ...
    if($result){
        ...
        while ($row = mysqli_fetch_assoc($result)){ ?>
            ...
            <tr>
                ...
                <td data-id="<?php echo $row['transaction_id'];?>"><?php echo $row['buyer_id']; ?></td>
                <td data-id="<?php echo $row['transaction_id'];?>"><?php echo $row['buyer_name']; ?></td>
                <td data-id="<?php echo $row['transaction_id'];?>"><?php echo $row['sell_date']; ?></td>
                ...
                <td data-id="<?php echo $row['transaction_id'];?>"><?php echo $row['sellprice_A']; ?></td>
                <td data-id="<?php echo $row['transaction_id'];?>"><?php echo $row['sellprice_B']; ?></td>
                <td data-id="<?php echo $row['transaction_id'];?>"><?php echo $row['sellprice_C']; ?></td>
...
<script src="buyer_transaction.js"></script>
</body>
</html>
